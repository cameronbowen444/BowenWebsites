  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto mb-12 max-w-3xl text-center">
        ...
        <h1 className="text-4xl font-black uppercase leading-[0.95] tracking-[-0.06em] text-[#f8f6f1] sm:text-5xl md:text-6xl">
          Websites Built
          <br />
          <span className="text-[#c89455]">To Bring In Clients.</span>
        </h1>

        <p className="mx-auto mt-5 max-w-2xl text-sm font-medium leading-relaxed text-[#f8f6f1]/60 sm:text-base">
          Premium websites, custom designs, branding direction, and unique
          styles built around your business.
        </p>
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        >
          <div className="flex w-max gap-6 px-1 sm:gap-8">
            {repeatedPages.map((page, index) => (
              ...
              >
                {/* Website wrapper */}
                <div className="relative overflow-hidden rounded-[1.65rem] border border-[#f8f6f1]/12 bg-[#f8f6f1]/[0.08] shadow-[0_26px_75px_rgba(0,0,0,0.35)] backdrop-blur-xl transition duration-300 group-hover:-translate-y-3 group-hover:border-[#c89455]/45 group-hover:shadow-[0_34px_95px_rgba(0,0,0,0.48)]">
                  <div className="pointer-events-none absolute inset-0 rounded-[1.65rem] ring-1 ring-[#f8f6f1]/10" />

                  {/* Browser top bar */}
                  <div className="relative z-10 flex h-11 items-center gap-3 border-b border-[#f8f6f1]/10 bg-[#102d4d]/95 px-4">
                    <div className="flex gap-1.5" aria-hidden="true">
                      <span className="h-3 w-3 rounded-full bg-[#c89455]" />
                      <span className="h-3 w-3 rounded-full bg-[#12345a]" />
                      <span className="h-3 w-3 rounded-full bg-[#f8f6f1]/50" />
                    </div>

                    <div className="h-5 flex-1 rounded-full bg-[#f8f6f1]/10" />

                    <div className="hidden text-[10px] font-black uppercase tracking-[0.16em] text-[#f8f6f1]/35 sm:block">
                      Preview
                    </div>
                  </div>

                  {/* Website image */}
                  <div className="relative aspect-[1.18/1] overflow-hidden bg-[#f8f6f1]">
                    <Image
                      src={page.image}
                    ...
                    <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#061525]/20 via-transparent to-[#f8f6f1]/10" />

                    <div className="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#061525]/90 via-[#061525]/35 to-transparent p-5 opacity-0 transition duration-300 group-hover:opacity-100">
                      <p className="text-sm font-black uppercase tracking-[0.12em] text-[#f8f6f1]">
                        {page.title}
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-4 flex items-center justify-between px-2">
                  <p className="text-sm font-black text-[#f8f6f1]/90">
                    {page.title}
                  </p>

                  <span className="rounded-full border border-[#f8f6f1]/10 bg-[#f8f6f1]/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.12em] text-[#c89455] shadow-sm backdrop-blur-md">
                    Website
                  </span>
                </div>
              </article>
        ...
        {/* Bottom style strip */}
        <div className="mx-auto mt-2 flex max-w-4xl flex-wrap items-center justify-center gap-3 text-xs font-black uppercase tracking-[0.16em] text-[#f8f6f1]/35">
          <span>Landing Pages</span>
          <span className="h-1 w-1 rounded-full bg-[#c89455]/50" />
