    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
          {plans.map((plan, index) => (
            <motion.article
              ...
              className={`group relative rounded-[1.15rem] border p-4 shadow-[0_18px_50px_rgba(0,0,0,0.2)] backdrop-blur-xl transition-all duration-300 ${
                plan.featured
            ...
            >
              ...
              <div
                className={`mb-5 flex h-9 w-9 items-center justify-center rounded-xl border text-base transition-all duration-300 ${
                  plan.featured
              ...
              <a
                href="#contact"
                className={`mt-5 flex items-center justify-center gap-2 rounded-lg px-4 py-2.5 text-[10px] font-black uppercase tracking-[0.12em] transition-all duration-300 ${
                  plan.featured
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.55 }}
          className="mx-auto mt-6 max-w-4xl rounded-[1.15rem] border border-accent/25 bg-accent/10 p-4 text-center shadow-[0_18px_50px_rgba(0,0,0,0.2)] backdrop-blur-xl"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.55 }}
          className="mx-auto mt-6 max-w-4xl rounded-[1.15rem] border border-white/10 bg-white/[0.065] p-4 shadow-[0_18px_50px_rgba(0,0,0,0.2)] backdrop-blur-xl"
        >
