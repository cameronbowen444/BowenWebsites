    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {projects.map((project, index) => (
            <motion.article
              ...
              className="group overflow-hidden rounded-[1.15rem] border border-white/10 bg-white/[0.065] shadow-[0_18px_50px_rgba(0,0,0,0.2)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-accent/40 hover:bg-white/[0.09]"
            >
              {/* Image */}
              <div className="relative h-40 overflow-hidden border-b border-white/10 bg-brand-light">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-brand via-brand/10 to-transparent" />
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.55 }}
          className="mx-auto mt-6 max-w-4xl rounded-[1.15rem] border border-accent/20 bg-accent/10 p-4 text-center shadow-[0_18px_50px_rgba(0,0,0,0.18)] backdrop-blur-xl"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.55 }}
          className="mx-auto mt-6 flex max-w-3xl flex-col items-center justify-between gap-4 rounded-[1.15rem] border border-white/10 bg-white/[0.065] p-4 text-center shadow-[0_18px_50px_rgba(0,0,0,0.18)] backdrop-blur-xl sm:flex-row sm:text-left"
        >
          <div>
